window.DSG_SITE_DATA = {
  links: {
    donation: 'https://www.zeffy.com/en-US/donation-form/donate-to-dsg',
  ...
  events: {
    ...
    pathCtaClick: 'path_cta_click',
    accordionToggle: 'accordion_toggle',
    donationAmountSelect: 'donation_amount_select',
